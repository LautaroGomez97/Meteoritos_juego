...
## Atributos onready
onready var animaacion  = $AnimationPlayer
...
func aleteorizarVelocidad() -> float:
	randomize()
...
func crear(pos: Vector2, dir: Vector2, tamanio: float)-> void:
	...
	#Calcular masa, tamaño sprite y Colisionador#
	mass *= tamanio
	...
	# Calcular Velocidad # 
	linear_velocity = vel_lineal_base * dir / tamanio * aleteorizarVelocidad()
	...
	#Calcular Velocidad
	linear_velocity = (vel_lineal_base * dir / tamanio) * aleteorizarVelocidad()
	angular_velocity = (vel_ang_base/ tamanio ) * aleteorizarVelocidad()
